...
public class SensorData extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public static org.jcb.kafka.schema.SensorData.Builder newBuilder() {
    return new org.jcb.kafka.schema.SensorData.Builder();
  }
   ...
   * @return A new SensorData RecordBuilder
   */
  public static org.jcb.kafka.schema.SensorData.Builder newBuilder(org.jcb.kafka.schema.SensorData.Builder other) {
    if (other == null) {
      return new org.jcb.kafka.schema.SensorData.Builder();
    } else {
      return new org.jcb.kafka.schema.SensorData.Builder(other);
    }
  }
   ...
   * @return A new SensorData RecordBuilder
   */
  public static org.jcb.kafka.schema.SensorData.Builder newBuilder(org.jcb.kafka.schema.SensorData other) {
    if (other == null) {
      return new org.jcb.kafka.schema.SensorData.Builder();
    } else {
      return new org.jcb.kafka.schema.SensorData.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<SensorData>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(org.jcb.kafka.schema.SensorData.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(org.jcb.kafka.schema.SensorData other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.sensorId)) {
        this.sensorId = data().deepCopy(fields()[0].schema(), other.sensorId);
    ...
    /**
      ...
      * @return This builder.
      */
    public org.jcb.kafka.schema.SensorData.Builder setSensorId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.jcb.kafka.schema.SensorData.Builder clearSensorId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.jcb.kafka.schema.SensorData.Builder setTemperature(double value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.jcb.kafka.schema.SensorData.Builder clearTemperature() {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.jcb.kafka.schema.SensorData.Builder setStatus(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.jcb.kafka.schema.SensorData.Builder clearStatus() {
      status = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public org.jcb.kafka.schema.SensorData.Builder setLastUpdate(long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public org.jcb.kafka.schema.SensorData.Builder clearLastUpdate() {
